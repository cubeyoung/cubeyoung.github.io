...
% 
%
% is the text embeddings by global text aligment and will be explained in later, 
...
%Here, $\mathcal{Q}$ denotes a linear layer for matching the concatenated embedding dimension to the original dimension, and $\odot$ is the Hadamard product.
...
% is outputs of the decoder using $\bs{S}_i$, $\bs{\hat S}_i$, and $\bs{S}^{\ast}_L$, and 
...
Here, %$\mbf{Y}$ refers to the  prediction without any our proposed component, and 
